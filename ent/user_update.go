...
// AddAuth adds the "auth" edges to the OAuth entity.
func (uu *UserUpdate) AddAuth(o ...*OAuth) *UserUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
...
// ClearAuth clears all "auth" edges to the OAuth entity.
func (uu *UserUpdate) ClearAuth() *UserUpdate {
	uu.mutation.ClearAuth()
	return uu
}

// RemoveAuthIDs removes the "auth" edge to OAuth entities by IDs.
func (uu *UserUpdate) RemoveAuthIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveAuthIDs(ids...)
	return uu
}

// RemoveAuth removes "auth" edges to OAuth entities.
func (uu *UserUpdate) RemoveAuth(o ...*OAuth) *UserUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	...
	if uu.mutation.AuthCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(oauth.FieldID, field.TypeInt),
			},
		}
...
// AddAuth adds the "auth" edges to the OAuth entity.
func (uuo *UserUpdateOne) AddAuth(o ...*OAuth) *UserUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
...
// RemoveAuth removes "auth" edges to OAuth entities.
func (uuo *UserUpdateOne) RemoveAuth(o ...*OAuth) *UserUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
